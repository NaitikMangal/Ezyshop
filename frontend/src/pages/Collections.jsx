...
const [sortType, setSortType] = useState('relave  nt');
...
useEffect(()=>{
     applyFilter();
},[category, subCategory, search, showSearch])  // it will applyFilter if category or subcategory change
...
// useEffect(()=>{  // use for display in console
...
// }, [subCategory])
  ...
  <div className='min-w-60' >
     ...
     <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '': 'hidden'} sm:block`}>
      ...
      <div className='flex flex-col gep-2 tetx-sm font-light text-gray-700' >
